"""
Vendored scaffold splitting utilities used to preserve Greenman-compatible
dataset splitting behavior in this artifact repo.

Originally adapted in the upstream Greenman code from Chemprop scaffold logic.
"""
